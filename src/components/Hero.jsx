  ...
  return (
    ...
    >
      ...
      <div className="z-10 max-w-xl py-12 text-center md:text-left text-white md:text-black dark:text-white">
        ...
        <a
          href="#contact"
          className="inline-block font-semibold bg-white dark:bg-white dark:text-black text-black px-6 py-3 border-2 border-white hover:bg-none rounded-full  transition"
        >
          Let's Work Together
        </a>
      </div>
